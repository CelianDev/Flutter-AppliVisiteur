class CompteRenduSubmission {
  ...
  factory CompteRenduSubmission.fromMap(Map<String, dynamic> map) {
    return CompteRenduSubmission(
...
class CompteRendu {
  ...
  final String bilan;
  final String motif;
  final Map<String, dynamic>? praticien; // Liste optionnelle de médicaments
  final String uuidVisiteur; // Utilisez String pour uuid_visiteur
  final List<Map<String, dynamic>>?
      medicaments; // Liste optionnelle de médicaments
  ...
  factory CompteRendu.fromMap(Map<String, dynamic> map) {
    return CompteRendu(
      dateVisite: DateTime.parse(map['date_visite']),
      praticien: map['praticien'] != null
          ? Map<String, dynamic>.from(map['praticien'])
          : null,
      motif: map['motif'],
      bilan: map['bilan'],
      uuidVisiteur: map['uuid_visiteur'],
